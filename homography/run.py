...
cv_desk = img_as_float(io.imread('D:/PycharmProjects/425_HW2/homography/cv_desk.jpg'))
cv_desk_gray = rgb2gray(cv_desk)
cv_cover = img_as_float(io.imread('D:/PycharmProjects/425_HW2/homography/cv_cover.jpg'))
hp_cover = img_as_float(io.imread('D:/PycharmProjects/425_HW2/homography/hp_cover.jpg'))
